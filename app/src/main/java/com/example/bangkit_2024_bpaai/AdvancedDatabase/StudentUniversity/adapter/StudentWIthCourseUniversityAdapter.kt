...
class StudentWIthCourseUniversityAdapter :
    ListAdapter<StudentWithCourseUniversity, StudentWIthCourseUniversityAdapter.WordViewHolder>(
        WordsComparator()
    ) {
    ...
    class WordViewHolder(private val binding: ItemStudentBinding) :
        ...
        fun bind(data: StudentWithCourseUniversity) {
    ...
    class WordsComparator : DiffUtil.ItemCallback<StudentWithCourseUniversity>() {
        override fun areItemsTheSame(oldItem: StudentWithCourseUniversity, newItem: StudentWithCourseUniversity): Boolean {
            return oldItem === newItem
        }

        override fun areContentsTheSame(oldItem: StudentWithCourseUniversity, newItem: StudentWithCourseUniversity): Boolean {
