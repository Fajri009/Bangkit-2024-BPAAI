package com.example.bangkit_2024_bpaai.Firebase.adapter
...
import com.example.bangkit_2024_bpaai.databinding.ItemMessageBinding
...
class FirebaseMessageAdapter(
    ...
    inner class MessageViewHolder(private val binding: ItemMessageBinding) :
        ...
        private fun setTextColor(userName: String?, textView: TextView) {
            if (currentUserName == userName && userName != null) { // Apabila currentUserName sama dengan data yang ada di database, dialog akan berwarna biru,
                textView.setBackgroundResource(R.drawable.rounded_message_blue)
            } else { // sedangkan jika tidak sama (alias nama akun lain), dialog akan berwarna kuning seperti berikut
