...
class SeatsView : View {
    ...
    // untuk mendeklarasikan masing-masing kursi
    ...
    // kita membutuhkan lebar dan panjang dari bawaan Custom View
    // untuk menentukan posisi X dan Y dari masing kursi yang kosong tersebut
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        // melakukan perulangan dari 0 sampai 7 untuk memeriksa apakah kursi berada di sebelah kanan atau kiri
        for (i in 0..7) {
            if (i.mod(2) == 0) {
                seats[i].apply {
                    x = halfOfWidth - 300F
    ...
    private fun drawSeat(canvas: Canvas?, seat: Seat) {
        ...
        // sebagai pembeda antara kursi yang masih kosong dengan yang telah dipilih
        if (seat.isBooked) {
    ...
    override fun onTouchEvent(event: MotionEvent?): Boolean {
        ...
        // ACTION_DOWN untuk mengenali setiap sentuhan yang dilakukan.
    ...
    private fun booking(position: Int) {
        ...
        // invalidate untuk me-refresh metode onDraw dalam SeatsView
        invalidate()
    }
}