...
class ImagesBannerWidget : AppWidgetProvider() {
    ...
    // onReceive() akan dijalankan ketika widget ditekan
    ...
    companion object {
        private const val TOAST_ACTION = "com.example.bangkit_2024_bpaai.TOAST_ACTION"
        const val EXTRA_ITEM = "com.example.bangkit_2024_bpaai.EXTRA_ITEM"
        ...
        private fun updateAppWidget(context: Context, appWidgetManager: AppWidgetManager, appWidgetId: Int) {
            ...
            // getBroadcast() untuk melakukan proses broadcast ketika salah satu widget ditekan
